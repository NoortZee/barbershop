        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="review-form-card">
                    <h2 class="text-center mb-4">Редактировать отзыв</h2>
                    ...
                    <form action="{{ route('reviews.update', $review) }}" method="POST" class="review-form">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control" id="comment" name="comment" rows="5" required minlength="10">{{ old('comment', $review->comment) }}</textarea>
                            <div class="form-text">Минимум 10 символов</div>
                        </div>

                        <div class="text-center">
                            <button type="submit" class="btn btn-premium">Сохранить изменения</button>
                        </div>
                    </form>
                </div>
            </div>
